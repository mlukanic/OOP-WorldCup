...
namespace WORLDCUP_ClassLibrary.Repositories
{
    public class WomenDataRepository : IWomenData
    {
        ...
        {
            string? json = await GetDataAsync(WomenConstants.WOMEN_MATCHES_PATH, WomenConstants.WOMEN_MATCHES_URI);
        ...
        {
            string? json = await GetDataAsync(WomenConstants.WOMEN_GROUP_RESULTS_PATH, WomenConstants.WOMEN_GROUP_RESULTS_URI);
        ...
        public async Task<List<Team>> GetAllTeamStatsAsyncWomen()
        {
            try
            {
                ...
                string? json = await GetDataAsync(WomenConstants.WOMEN_TEAMS_PATH, WomenConstants.WOMEN_TEAMS_URI);
        ...
        public async Task<List<Player>> GetFavoriteTeamPlayersWomen()
        {
            ...
            {
                Loading.LoadingScreen?.Show();
                var matches = await GetSpecificCountryMatchResultsAsyncWomen(UserPreferences.FavouriteCountryCode.ToString());
        ...
        {
            string? json = await GetDataAsync(WomenConstants.WOMEN_MATCHES_PATH, WomenConstants.WOMEN_COUNTRY_URI + countryCode.ToUpper());
            if (json != null)
            {
